    ...
    <Router>
      <Routes>
          ...
          element={
            ...
            >
              <button
                ...
                className="absolute top-4 right-6 p-3 rounded-full hover:bg-opacity-100 transition-all duration-300 focus:outline-none"
              >
                {darkMode ? (
                  <BsFillSunFill
                    size={30}
              ...
              >
                <span className="text-yellow-400">Discover</span> Deeper Insights from Every Word
              </h1>
              ...
              >
                ...
                <span className="text-green-400 font-bold">phishing risks</span>, identify{' '}
                <span className="text-green-400 font-bold">malicious intent</span> and{' '}
                <span className="text-green-400 font-bold">fraudulent patterns</span>, assess{' '}
                <span className="text-green-400 font-bold">emotional tone</span>, and detect subtle{' '}
                <span className="text-green-400 font-bold">psychological cues</span>. Unlock insights for more.
              </p>
        ...
        <Route
          ...
          element={
            <div
              className={`min-h-screen flex justify-center items-center text-center px-6 py-8 sm:py-12 ${
                darkMode ? 'bg-gray-900 text-white' : 'bg-white text-black'
              }`}
            >
              <InputForm />
